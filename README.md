...
- [here](![Image](https://github.com/user-attachments/assets/50bd208f-ffbf-4371-bcb1-c6717f7e62df)) {This stage "Declarative tool" install will come up automatically when we inject the tool in the code. You can use this system to install Java, maven etc}
